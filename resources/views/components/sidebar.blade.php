    ...
    <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-gray-100">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <div class="px-3 mt-6 relative inline-block text-left">
                <x-jet-dropdown>
                    <x-slot name="trigger">
                        <button type="button" class="transition ease-in-out duration-150 group w-full bg-gray-100 rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
